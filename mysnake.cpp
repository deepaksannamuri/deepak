...
cout<<"\n*****************************************************************\n";
	...
	cout<<"*****************************************************************\n";
	cout<<"+(L) IN SNAKE AND LADER BOARD REPRESENTS STARTING POINT OF THE LADDER AND (L) REPRESENTS ENDING POINT OF THE LADDER\n";
	cout<<"+(S) IN SNAKE AND LADER BOARD REPRESENTS HEAD OF THE SNAKE AND (S) REPRESENTS TAIL OF THE SNAKE\n";
	int a,b,e,n;
	cout<<"Enter single or double players \n";
	cin>>n;
	if(n==1)
	{
	a=0;
